...
Static documentation or brochure websites
Getting started - Clone the repo, open index.html in your browser, and edit the HTML/CSS to customize the site. For local development with live reload, use any static-server tool (e.g., live-server, http-server).
